...
\begin{document}
	...
	\section{Introduction, Permutations, and Combinations} \lecture{January 7, 2013}
		...
		\subsection{Sample Graph Theory Problems}
			...
			The \textbf{four-colour theorem} (proven later in the course) states that you can always do this with four colours. It's also always possible to colour these regions with five colours. It's \emph{sometimes} possible to colour the regions with three or fewer colours, depending on the layout of the regions and their boundaries.
