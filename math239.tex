...
\begin{document}
	...
	\section{Power Series and Generating Functions}
		...
		\subsection{Working With (Formal) Power Series}
			...
			\begin{defn}[Addition of power series]
				We define addition of power series as follows.
				\begin{align*}
			...
			\begin{defn}[Multiplication of power series]
				We define multiplication of power series as follows.
				\begin{align*}
			...
			\begin{defn}[Inverse of power series]
			...
			\begin{ex}
				...
				\end{align*}
				Similarly, $b_3 = b_4 = \cdots = 0$. Thus, the inverse if $(1 + x)$.
			\end{ex}
