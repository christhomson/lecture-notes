...
\tikzset{
	dot/.style 2 args={circle,inner sep=2.5pt,fill,label=#1:{#2},name=#2}
}
...
\begin{document}
	...
	\section{Introduction to Graph Theory} \lecture{February 15, 2013} % Today's notes were taken from Kevin Cho's handwritten notes (thanks!). 
		...
		\subsection{Isomorphism}
			...
			\begin{theorem}
				For any graph $G = (V, E)$, $\displaystyle \sum_{v \in V} \deg(v) \ge 2|E|$.
			\end{theorem}
			...
			\begin{ex} Given the following table:
				...
				There are 5 odd numbers of friends.
			\end{ex}
	\newpage
