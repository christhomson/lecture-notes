      ...
      \begin{ex}
        ...
        \subsubsection{Uses of NFAs}
          ...
          \begin{ex} \lecture{October 1, 2013}
            ...
            $N$ accepts all strings where the second-to-last letter is 1. Note that $N$ is nondetermistic because $q_0$ has two edges for 1, and $q_2$ has no edges. By way of subset construction, we can construct an equivalent DFA:
            \begin{center}
              \begin{tikzpicture}[scale=0.2]
                \tikzstyle{every node}+=[inner sep=0pt]
                \draw [black] (11.4,-14.5) circle (3);
