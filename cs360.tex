  ...
  \subsection{Undecidability: The Halting Problem}
    ...
    \subsection{Some Well-Known Undecidable Problems}
      ...
      \subsubsection{Post Correspondence Problem (PCP)}
        ...
        \\ \\
        If you can use each of the dominoes exactly once, this is decidable. However, if you're allowed to use each of them as a template, meaning you can use each domino as many times as you'd like, then this is an undecidable problem.
