  ...
  \section{Context-Free Grammars} \lecture{October 15, 2013}
    ...
    \subsection{Pushdown Automata}
      ...
      \subsection{Ogden's Lemma: Pumping Lemma for Context-Free Languages}
        ...
        \begin{ex}
          ...
          \begin{proof}
            ...
            \\ \\
            Therefore, $X_1 X_2^k X_3 X_4^k X_5$ does no longer have the same number of occurrences of $a$, $b$, and $c$. So, $X_1 X_2^k X_3 X_4^k X_5 \not \in L$. $L$ fails the Pumping Lemma, which shows that $L$ is not context-free.
          \end{proof}
        \end{ex}
      ...
      \begin{lemma}[Noam Chomsky's Generative Grammar]
        Every context-free language can be generated by a grammar of the following restricted form. Every generation rule in the language is of one of these forms:
        \begin{itemize}
      ...
      \begin{proof}
        ...
        \\ \\
        Since depth($T$) $\ge \log(|w|)$ (by the second lemma) and $|w| \ge n = 2^{|V| + 2}$, depth($T$) $> |V| + 1$.
        \\ \\
      ...
      \subsection{Deciding Membership in a Context-Free Language} \lecture{October 31, 2013}
        ...
        \subsubsection{Method 2: Tableau Method}
          ...
          \\ \\
          \textbf{Bottom row}: for each $X{ii}$, we need to find all $A \in V$ such that $A \underset{G}{\overset{\star}{\implies}} a_i$.
          \\ \\
      ...
      \subsection{Closure Properties of Context-Free Languages}
        ...
        \subsubsection{Non-closure of Context-Free Languages Under Intersection}
          ...
          \begin{proof}
            ...
            It's also easy to see that a pushdown automata would also be possible. We would simply push onto the stack for every $a$, and pop for every $b$.
            \\ \\
