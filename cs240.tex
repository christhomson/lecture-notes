			...
			\subsubsection{Implementations of Dictionaries}
				...
				\subsubsection{2-3 Trees}
					...
					\textbf{Deletion}:
						...
						After a deletion, you need to recursve upwards ensuring that are all parents still satisfy all requirements of 2-3 trees. At the very top of the tree, you may have a case like in \ref{figure:23rootgone1}.
