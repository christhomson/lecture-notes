	...
	\section{Abstract Data Types}
		...
		\subsection{Priority Queue} \lecture{January 22, 2013}
			...
			\subsubsection{Applications of Priority Queues}
				...
				Priority queues can be used for sorting purposes. It allows us to sort without worrying about the underlying sorting implementation. However, if we want to know how good of a sorting algorithm it is, we would need to examine the implementation of \verb+insert+ and \verb+deleteMin+. Here's some pseudo-code for sorting with a priority queue: \\
				\begin{algorithm}[H]
					\For{i = 0 to n - 1}{
