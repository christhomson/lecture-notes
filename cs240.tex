...
\begin{document}
	...
	\section{Formalism} \lecture{January 15, 2013}
		...
		\begin{defn}
			We say an algorithm \textbf{solves} a probem if for every question $Q$ it produces the correct answer, $A$.
		\end{defn}
		...
		\begin{enumerate}
			...
			\item \textbf{Algorithm analysis}. Assess the correctness and efficency of the algorithm.
		\end{enumerate}
	...
	\section{Analysis of Algorithms}
		...
		\subsection{Techniques for Algorithm Analysis}
			...
			\begin{ex}
				...
				\verb+for i = a to be do+ \\
				\bigg[ \verb+<straight line program>+ $T_L$ \bigg] \\ \\
