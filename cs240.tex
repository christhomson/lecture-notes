...
\begin{document}
	...
	\section{Tricks of the Trade}
		...
		\subsection{Skip Lists}
			...
			\\ \\
			If you insert in the bottom layer, the shortcuts still work and don't need to be changed \textendash{} the shortcut just becomes a bit longer. If the shortcut becomes too large, simply break the shortcut into two.
\end{document}
