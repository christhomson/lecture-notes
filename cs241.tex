			...
			\end{itemize}
				\subsection{Pass 2 \textendash{} Synthesis}
					...
					\subsubsection{Creating MIPS Binary Instructions}
						We can form a MIPS binary instruction using a template and appropriate values for any variables in the command (usually denoted $s$, $t$, and $d$). \\ \\
						TODO - finish discussing bitwise operators, etc.
\end{document}
