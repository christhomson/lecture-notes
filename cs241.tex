			...
			\subsubsection{Deterministic Finite Automaton (DFA)}
				...
				\begin{center}
					\begin{tikzpicture}[scale=0.2]
						...
						\draw (16.8,-17.2) node {wilma};
						\draw [black] (38,-24.5) circle (3);
						\draw (38,-24.5) node {fred};
						\draw [black] (38,-24.5) circle (2.4);
						\draw [black] (19.7,-31.8) circle (3);
						\draw (19.7,-31.8) node {pebbles};
						\draw [black] (19.7,-31.8) circle (2.4);
						\draw [black] (55.7,-18.5) circle (3);
						\draw (55.7,-18.5) node {barney};
						\draw [black] (19.64,-18.18) -- (35.16,-23.52);
						\fill [black] (35.16,-23.52) -- (34.57,-22.79) -- (34.24,-23.74);
						\draw (26.5,-21.38) node [below] {$0$};
						\draw [black] (17.38,-20.14) -- (19.12,-28.86);
						\fill [black] (19.12,-28.86) -- (19.45,-27.98) -- (18.47,-28.17);
						\draw (17.51,-24.81) node [left] {$1$};
						\draw [black] (21.846,-29.721) arc (161.81889:-126.18111:2.25);
						\draw (26.89,-29.07) node [right] {$0,\mbox{ }1$};
						\fill [black] (22.66,-32.24) -- (23.26,-32.96) -- (23.57,-32.01);
						\draw [black] (40.84,-23.54) -- (52.86,-19.46);
						\fill [black] (52.86,-19.46) -- (51.94,-19.25) -- (52.26,-20.19);
						\draw (48.65,-22.07) node [below] {$0,\mbox{ }1$};
						\draw [black] (40.84,-23.54) -- (52.86,-19.46);
						\fill [black] (52.86,-19.46) -- (51.94,-19.25) -- (52.26,-20.19);
						\draw [black] (11.1,-11.9) -- (14.6,-15.16);
						\draw (10.57,-10.44) node [left] {$i$};
						\fill [black] (14.6,-15.16) -- (14.36,-14.25) -- (13.68,-14.98);
					\end{tikzpicture}
				\end{center}
