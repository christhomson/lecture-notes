	...
	\section{The Big Picture: Building a Compiler} \lecture{March 13, 2013}
		...
		\subsection{Code Generation} \lecture{March 15, 2013}
			...
			\subsubsection{Variables}
				...
				Note that the representation for NULL is conventionally zero. This is \emph{okay}, but ideally we'd choose a NULL representation that is not a multiple of four, so as not to confuse it with an actual memory address.
				\\ \\
