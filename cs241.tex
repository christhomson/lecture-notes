	...
	\section{Compiler Optimization} \lecture{April 5, 2013}
		...
		\subsection{Register Allocation}
			...
			\subsubsection{Register Allocation for Subexpressions}	
				...
				Ultimately, we need to determine how many registers a given expression needs, and then we choose to evaluate the one that needs the minimum number of registers first.
				\\ \\
