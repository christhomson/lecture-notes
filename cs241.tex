...
\begin{document}
	...
	\section{The Big Picture: Building a Compiler} \lecture{March 13, 2013}
		...
		\subsection{Code Generation} \lecture{March 15, 2013}
			...
			Let's look at more conventions, specifically how to represent parameters. For now, (and we'll probably change this later when we represent variables), \$1 is the first parameter and \$2 is the seco.nd parameter. We're going to need to expand our symbol table to include how each symbol is represented:
